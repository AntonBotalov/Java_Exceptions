...
public class Main {
    ...
    public static void writeHumanInFile() {
        ...
        try {
            ...
            File file = new File("HW_3/"+ h.getFamilyName() + ".txt");
    ...
    public static Human getHuman(String[] humanInfo) throws Exception {
        ...
        Human human = new Human(
                ...
                humanInfo[1],
                humanInfo[2],
                new Date(Integer.parseInt(date[2]) - 1900,
    ...
    public static String getString() {
        ...
        System.out.print(
                "Введите информацию в формате - Фамилия Имя Отчество Дата рождения(dd.mm.yyyy) Номер телефона(79523532543) Пол(f/m): ");
        while (true) {
    ...
    public static String checkError(int error) {
        if (error == -1)
            return String.format("Код ошибки - %d: Указано больше элементов информации", error);
        else if (error == -2)
            return String.format("Код ошибки - %d: Указано меньше элементов информации", error);
